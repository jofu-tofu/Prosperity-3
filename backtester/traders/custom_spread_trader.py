...
class Trader:
    """
    Custom Spread Trader that exclusively trades the custom spread (3×PB2 + 2×DJEMBES - 2×PB1)
    ...
    def __init__(self):
        ...
        self.exit_price_adjustment = 0   # Willing to pay 1 unit worse than mid price to exit a position
    ...
    def run(self, state: TradingState) -> Tuple[Dict[str, List[Order]], int, str]:
        ...
        result = {}
        logger.print("Custom Spread Trader starting...")
        ...
        z_score = custom_spread / self.fixed_std_dev
        ...
        # Determine trade signal for custom spread
        spread_signal = None
        ...
        # Check if position limits would be violated
        scale_factor = 1.0
                ...
                if product in state.order_depths:
                    ...
                    if len(order_depth.sell_orders) > 0:
                        ...
                        if abs(z_score) >= self.entry_threshold:  # Entering a position
                            ...
                            if (z_score > 0 and self.spread_position > 0) or (z_score < 0 and self.spread_position < 0):
                                price_adjustment = self.exit_price_adjustment
                            else:
                                price_adjustment = self.entry_price_adjustment
