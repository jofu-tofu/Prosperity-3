        ...
        for product in state.order_depths:
            if product == "RAINFOREST_RESIN":
                ...
                if (
                    ...
                    and list(order_depth.sell_orders.items())[0][0] == 10005
                    or (
                        list(order_depth.sell_orders.items())[0][0] == 10004
                        and list(order_depth.sell_orders.items())[0][1] == -1
                    )
                ):
                    orders.append(Order(product, acceptable_price + 4, max_sell))
                elif (
                    len(order_depth.sell_orders) != 0
                    and list(order_depth.sell_orders.items())[0][0] == 10003
                ):
                    orders.append(Order(product, acceptable_price + 2, max_sell))
                elif (
                    len(order_depth.sell_orders) != 0
                    and list(order_depth.sell_orders.items())[0][0] == 10002
                ):
                    orders.append(Order(product, acceptable_price + 1, max_sell))
                elif (
                    len(order_depth.sell_orders) != 0
                    and list(order_depth.sell_orders.items())[0][0] == 10000
                    and position > 0
                ):
                ...
                if (
                    ...
                    and list(order_depth.buy_orders.items())[0][0] == 9995
                    or (
                        list(order_depth.buy_orders.items())[0][0] == 9996
                        and list(order_depth.buy_orders.items())[0][1] == 1
                    )
                ):
                    orders.append(Order(product, acceptable_price - 4, max_buy))
                elif (
                    len(order_depth.buy_orders) != 0
                    and list(order_depth.buy_orders.items())[0][0] == 9997
                ):
                    orders.append(Order(product, acceptable_price - 2, max_buy))
                elif (
                    len(order_depth.buy_orders) != 0
                    and list(order_depth.buy_orders.items())[0][0] == 9998
                ):
                    orders.append(Order(product, acceptable_price - 1, max_buy))
                elif (
                    len(order_depth.buy_orders) != 0
                    and list(order_depth.buy_orders.items())[0][0] == 10000
                    and position < 0
                ):
                    orders.append(Order(product, acceptable_price, -position))
                else:
